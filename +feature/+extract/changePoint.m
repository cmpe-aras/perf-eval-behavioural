function [dataWithFeat,pars] = changePoint(data,pars)
% INPUT 
...
%
% OUTPUT
% dataWithFeat contains the change point representation of features in the dataset and is a struct with
...
% Calculate Change Point Features
if timeStepSize ~= 1
    ...
    FeatMat = data.observations;
end
% Remove features that do not contribute
% FeatMat = FeatMat(find( max(FeatMat,[],2) == 1), :);

% Calculte the labels using majority voting
